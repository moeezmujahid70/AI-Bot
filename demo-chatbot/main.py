...
if __name__ == "__main__":
    ...
    genai.configure(api_key=os.getenv("GEMINI_API_KEY"))  # Note: NOT OpenAI key now

    Gui(page).run(debug=True, dark_mode=True, use_reloader=True, title="💬 Taipy Chat with Gemini 1.5 Pro")
